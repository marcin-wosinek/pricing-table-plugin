  ...
  return (
    <div className="pricing-tier">
      <PlainText
        ...
        placeholder={__("Enter tier name...", "pricing-table-plugin")}
      />
      <RichText
        tagName="p"
        ...
        placeholder={__("Enter tier description...", "pricing-table-plugin")}
      />
      ...
      <div className="tier-action">
        <PlainText
          ...
          value={tier.buttonLabel || __("Get Started", "pricing-table-plugin")}
          onChange={(value) => updateTierButtonLabel(index, value)}
          placeholder={__("Button text...", "pricing-table-plugin")}
        />
        <URLInputButton
          url={tier.buttonUrl || ""}
          onChange={(url) => updateTierButtonUrl(index, url)}
          text={tier.buttonLabel || __("Get Started", "pricing-table-plugin")}
      ...
      <h4 className="features-header">
        {index === 0
          ...
          : __("Everything in %s and:", "pricing-table-plugin").replace(
              "%s",
              tiers[index - 1].name,
            )}
      </h4>
        ...
        {(tier.features || []).map((feature, featureIndex) => (
          <li key={featureIndex} className="feature-item">
            <PlainText
              ...
              placeholder={__("Enter feature...", "pricing-table-plugin")}
            />
            <Button
